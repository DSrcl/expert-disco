...
public:
  ...
  virtual MachineInstr *getGlobalPICAddr(MachineFunction &MF, unsigned DestReg,
                                         const TargetMachine *TM,
                                  GlobalVariable *GV) const {
    llvm_unreachable("Target didn't implement "
                     "TargetInstrInfo::getGlobalPICAddr");
  }

  virtual MachineInstr *storeReg(MachineFunction &MF, unsigned SrcReg,
                                 unsigned IndexReg, unsigned Offset,
                                 const TargetRegisterClass *RC) const {
    llvm_unreachable("Target didn't implement "
                     "TargetInstrInfo::storeReg");
  }
